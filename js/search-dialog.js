$('.dialogs__search-input').keyup(() => {
    $('.dialogs__search-input').jcOnPageFilter();
}) 
...
jQuery.fn.jcOnPageFilter = function(settings) {
    settings = jQuery.extend({
        ...
        caseSensitive: false,
        hideNegatives: true,
        parentSectionClass: 'dialogs__list',
        parentLookupClass: 'dialogs__item',
        childBlockClass: 'username',
